...
func GetDefault() ConfigClient {
	return ConfigClient{
		SenderPublicKey: config.MakeKey("-----BEGIN PUBLIC KEY-----enter key here-----END PUBLIC KEY-----", config.Display{Description: "Your Public Key", Name: "Sender's Public Key", Group: "Asymmetric Encryption"}),
		...
		ReceiverPublicKey: config.MakeKey("-----BEGIN PUBLIC KEY-----enter key here-----END PUBLIC KEY-----", config.Display{Description: "Receiver's Public Key", Name: "Senders Public Key", Group: "Asymmetric Encryption"}),
