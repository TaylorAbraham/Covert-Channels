...
func GetDefault() ConfigClient {
	return ConfigClient{
		...
		Encoder:           config.MakeSelect("id", []string{"id", "urgflg", "urgptr", "time"}, config.Display{Description: "The encoding mechanism to use for this protocol.", Name: "Encoding", Group: "Settings"}),
	}
}
